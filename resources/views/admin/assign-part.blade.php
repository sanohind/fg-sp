    ...
    <div class="mb-6">
        <nav class="text-sm font-semibold mb-2" aria-label="Breadcrumb">
            <ol class="list-none p-0 inline-flex">
                ...
                <li class="flex items-center">
                    <span class="text-[#0A2856]">Assign Part</span>
                </li>
            </ol>
        </nav>
        <h1 class="text-2xl font-bold text-gray-900">Assign Part</h1>
    </div>
    ...
    <form action="{{ route('admin.slot.store-assign-part', $slot->id) }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                <label for="part_name" class="block text-sm font-medium text-gray-700 mb-1">Part Name</label>
                <input type="text" 
                       name="part_name" 
                       id="part_name" 
