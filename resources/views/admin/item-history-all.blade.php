...
@section('title', 'Item History All')
    ...
    <div class="mb-6">
        <nav class="text-sm font-semibold mb-2" aria-label="Breadcrumb">
            <ol class="list-none p-0 inline-flex">
                ...
                <li class="flex items-center">
                    <span class="text-[#0A2856]">All Item History</span>
                </li>
            </ol>
        </nav>
        <h1 class="text-2xl font-bold text-gray-900">All Item History</h1>
    </div>

    <!-- History Table -->
    <div class="overflow-x-auto">
        <table id="itemHistoryAllTable" class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        @if($history->item)
                            <div>
                                <div class="font-medium">{{ $history->item->part_no }}</div>
                                <div class="text-gray-500">{{ $history->item->description }}</div>
                            </div>
                        @else
