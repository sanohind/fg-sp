        ...
        <form action="{{ route('admin.rack.update', $rack->id) }}" method="POST">
            ...
            <div class="mt-6">
                ...
                <textarea id="reason" 
                          name="reason" 
                          rows="3"
                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0A2856] focus:border-transparent @error('reason') border-red-500 @enderror"
